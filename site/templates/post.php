<?php snippet('header') ?>
  ...
  <header class="container max-width-xs margin-bottom-lg">
    <div class="text-component text-center line-height-lg v-space-md margin-bottom-md">
      ...
      <a href="video.html" class="story__category">
  ...
  <?php endif ?>
        ...
        <div class="author__content text-component v-space-xxs">
          <h4 class="text-base"><a href="#0" rel="author"><?= $author->name() ?></a></h4>
          <p class="text-sm color-contrast-medium"><time datetime="<?= $page->published()->toDate('c') ?>" pubdate="pubdate"><?= $page->published()->toDate('d.m.Y H:i') ?></time></p>
        </div>
      </div>
    </div>
  </header>
