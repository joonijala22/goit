...
$p2 = page('news');         
  $filterBy = get('filter');
  $firstblogs = $p->children()->listed()->sortBy('date', 'asc')->filterBy('tags', 'news', ',')->flip()->limit(3);
  $lblogs = $p2->children()->listed()->sortBy('date', 'asc')->filterBy('tags', 'news', ',')->flip()->offset(3)->paginate(3);
?>
