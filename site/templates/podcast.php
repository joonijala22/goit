    ...
    <div class="container max-width-adaptive-lg">
      <nav class="breadcrumbs" aria-label="Breadcrumbs">
        <ol class="flex flex-wrap gap-xxs">
          ...
          <li class="breadcrumbs__item color-primary" aria-current="page">Podcast</li>
        </ol>
      </nav>
    </div>
  </section>
...
$p2 = page('news');         
  $filterBy = get('filter');
  $firstblogs = $p->children()->listed()->sortBy('date', 'asc')->filterBy('tags', 'podcast', ',')->flip()->limit(3);
  $lblogs = $p2->children()->listed()->sortBy('date', 'asc')->filterBy('tags', 'podcast', ',')->flip()->offset(3)->paginate(3);
?>
