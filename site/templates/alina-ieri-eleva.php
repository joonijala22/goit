...
<section>
  <div class="article">
    <div class="container max-width-adaptive-lg position-relative">
        ...
        <div class="grid gap-lg justify-between align-middle">
          <div class="col-9@md margin-y-md">
            <div class="responsive-iframe ">
              <?= $page->videolink() ?>
            </div>
          </div>

          <div class="col-3@md margin-y-md">
            
            <div class="text-component">
              <h2 class="color-primary"><?= $page->heading2() ?></h2>
              <p><? $page->text1() ?></p>
              <p class="text-sm@lg font-italic"><?php $page->slanttext() ?></p>
